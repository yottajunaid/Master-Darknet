...
<CardGrid>
  <Card title="6-practical-search-techniques-on-onion-networks" href=".//Master-Darknet/docs/practical-darknet-operations/6-practical-search-techniques-on-onion-networks" icon="document-text" />
</CardGrid>