...
<CardGrid>
  <Card title="7-onion-link-discovery-and-validation" href=".//Master-Darknet/docs/practical-darknet-operations/7-onion-link-discovery-and-validation" icon="document-text" />
</CardGrid>