...
<CardGrid>
  <Card title="16-monitoring-onion-site-availability" href=".//Master-Darknet/docs/practical-darknet-operations/16-monitoring-onion-site-availability" icon="document-text" />
</CardGrid>