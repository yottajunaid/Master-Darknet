...
<CardGrid>
  <Card title="18-operational-security-opsec-failures-in-practice" href=".//Master-Darknet/docs/practical-darknet-operations/18-operational-security-opsec-failures-in-practice" icon="document-text" />
</CardGrid>