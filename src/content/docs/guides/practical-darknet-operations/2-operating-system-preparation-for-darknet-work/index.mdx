...
<CardGrid>
  <Card title="3-network-level-anonymity-foundations" href=".//Master-Darknet/docs/practical-darknet-operations/3-network-level-anonymity-foundations" icon="document-text" />
</CardGrid>