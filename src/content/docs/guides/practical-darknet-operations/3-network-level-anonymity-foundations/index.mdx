...
<CardGrid>
  <Card title="4-installing-and-verifying-tor-software" href=".//Master-Darknet/docs/practical-darknet-operations/4-installing-and-verifying-tor-software" icon="document-text" />
</CardGrid>