...
<CardGrid>
  <Card title="12-file-transfer-and-content-handling" href=".//Master-Darknet/docs/practical-darknet-operations/12-file-transfer-and-content-handling" icon="document-text" />
</CardGrid>