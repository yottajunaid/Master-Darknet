...
<CardGrid>
  <Card title="11-cryptography-in-practical-darknet-use" href=".//Master-Darknet/docs/practical-darknet-operations/11-cryptography-in-practical-darknet-use" icon="document-text" />
</CardGrid>