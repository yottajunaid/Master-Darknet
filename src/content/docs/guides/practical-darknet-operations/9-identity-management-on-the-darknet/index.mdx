...
<CardGrid>
  <Card title="10-darknet-communication-mechanisms" href=".//Master-Darknet/docs/practical-darknet-operations/10-darknet-communication-mechanisms" icon="document-text" />
</CardGrid>