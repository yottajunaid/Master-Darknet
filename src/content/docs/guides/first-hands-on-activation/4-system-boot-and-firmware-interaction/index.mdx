...
<CardGrid>
  <Card title="5-initial-tails-startup-and-welcome-screen" href=".//Master-Darknet/docs/first-hands-on-activation/5-initial-tails-startup-and-welcome-screen" icon="document-text" />
</CardGrid>