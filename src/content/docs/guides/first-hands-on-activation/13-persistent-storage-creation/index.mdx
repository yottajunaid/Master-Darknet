...
<CardGrid>
  <Card title="14-managing-persistent-storage-features" href=".//Master-Darknet/docs/first-hands-on-activation/14-managing-persistent-storage-features" icon="document-text" />
</CardGrid>