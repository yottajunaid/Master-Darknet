...
<CardGrid>
  <Card title="17-time-locale-and-fingerprinting-awareness" href=".//Master-Darknet/docs/first-hands-on-activation/17-time-locale-and-fingerprinting-awareness" icon="document-text" />
</CardGrid>