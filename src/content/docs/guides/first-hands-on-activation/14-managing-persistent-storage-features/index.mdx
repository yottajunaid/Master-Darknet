...
<CardGrid>
  <Card title="15-cryptographic-identity-initialization" href=".//Master-Darknet/docs/first-hands-on-activation/15-cryptographic-identity-initialization" icon="document-text" />
</CardGrid>