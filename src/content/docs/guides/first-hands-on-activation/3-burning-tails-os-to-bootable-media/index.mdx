...
<CardGrid>
  <Card title="4-system-boot-and-firmware-interaction" href=".//Master-Darknet/docs/first-hands-on-activation/4-system-boot-and-firmware-interaction" icon="document-text" />
</CardGrid>