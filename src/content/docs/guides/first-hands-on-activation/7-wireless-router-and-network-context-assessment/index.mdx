...
<CardGrid>
  <Card title="8-connecting-to-wireless-networks-via-external-adapter" href=".//Master-Darknet/docs/first-hands-on-activation/8-connecting-to-wireless-networks-via-external-adapter" icon="document-text" />
</CardGrid>