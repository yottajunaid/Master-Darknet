...
<LinkCard title="8. Connecting to Wireless Networks via External Adapter" href="/Master-Darknet/guides/first-hands-on-activation/8-connecting-to-wireless-networks-via-external-adapter/" />