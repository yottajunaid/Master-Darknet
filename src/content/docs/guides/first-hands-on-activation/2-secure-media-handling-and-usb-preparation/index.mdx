...
<CardGrid>
  <Card title="3-burning-tails-os-to-bootable-media" href=".//Master-Darknet/docs/first-hands-on-activation/3-burning-tails-os-to-bootable-media" icon="document-text" />
</CardGrid>