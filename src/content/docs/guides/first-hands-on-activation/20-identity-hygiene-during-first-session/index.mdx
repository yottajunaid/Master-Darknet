...
<CardGrid>
  <Card title="21-session-monitoring-and-awareness" href=".//Master-Darknet/docs/first-hands-on-activation/21-session-monitoring-and-awareness" icon="document-text" />
</CardGrid>