...
<CardGrid>
  <Card title="10-tor-circuit-establishment-practical-view" href=".//Master-Darknet/docs/first-hands-on-activation/10-tor-circuit-establishment-practical-view" icon="document-text" />
</CardGrid>