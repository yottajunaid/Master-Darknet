...
<CardGrid>
  <Card title="11-opening-and-verifying-tor-browser" href=".//Master-Darknet/docs/first-hands-on-activation/11-opening-and-verifying-tor-browser" icon="document-text" />
</CardGrid>