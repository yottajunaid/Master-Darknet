...
<CardGrid>
  <Card title="7-wireless-router-and-network-context-assessment" href=".//Master-Darknet/docs/first-hands-on-activation/7-wireless-router-and-network-context-assessment" icon="document-text" />
</CardGrid>